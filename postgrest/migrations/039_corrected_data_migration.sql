-- Corrected data migration for EAV system
-- This migration converts existing data_models and data_records to the new EAV pattern

BEGIN;

-- Migrate data_model_attributes to eav_attributes (corrected version)
...
-- Migrate data_records to eav_entities (corrected version)
...
-- Migrate data_record_values to eav_values (corrected version)
