...
import { Plus, Search, List, Kanban as KanbanIcon, Loader } from 'lucide-react'
...
export function TicketsList({
  ...
  const [view, setView] = useState<'kanban' | 'list'>(viewMode as 'kanban' | 'list')
  ...
  const { tickets, loading, refetch, spaceFilter } = useTickets({
