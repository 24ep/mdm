...
export function WidgetItem({
  ...
  return (
    <div
      className="flex flex-col items-center justify-center gap-1 px-2 py-3 bg-background border rounded-md cursor-move hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:border-blue-300 transition-colors relative"
      draggable={true}
    ...
    >
      ...
      <span className="text-[10px] text-gray-700 dark:text-gray-300 text-center truncate w-full">
        {widget.label}
      </span>
