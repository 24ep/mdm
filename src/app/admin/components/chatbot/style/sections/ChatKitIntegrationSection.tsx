  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pt-2">
        ...
        <SectionGroup title={isChatKitEngine ? "Regular Style UI Settings" : "ChatKit Regular Style Settings"} isFirst={!isOpenAIAgentSDK}>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
        ...
        {/* Header Configuration - always shown */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Display the close (X) button in header</p>
              </div>
              <Switch
                checked={(formData as any).headerShowCloseButton !== false}
                onCheckedChange={(checked) => setFormData({ ...formData, headerShowCloseButton: checked } as any)}
              />
            </div>
          </div>
        </SectionGroup>
