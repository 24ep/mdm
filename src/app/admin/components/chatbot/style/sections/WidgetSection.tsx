...
import { Palette, Bot, Maximize, Square, Sun, Tag, Move } from 'lucide-react'
      ...
      <AccordionContent className="pt-4 pb-6">
        <div className="space-y-4">
          ...
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="avatar-icon" className="border-b">
              <AccordionTrigger className="hover:no-underline py-4 text-md font-semibold">
                <div className="flex items-center gap-2">
            ...
            <AccordionItem value="size-colors" className="border-b">
              <AccordionTrigger className="hover:no-underline py-4 text-md font-semibold">
                <div className="flex items-center gap-2">
            ...
            <AccordionItem value="borders" className="border-b">
              <AccordionTrigger className="hover:no-underline py-4 text-md font-semibold">
                <div className="flex items-center gap-2">
