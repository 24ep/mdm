...
export const DEFAULT_CHATBOT_CONFIG: Partial<Chatbot> = {
  ...
  getStartedIcon: 'Bot',
  getStartedTitle: 'Welcome to Chat',
  getStartedSubtitle: 'How can we help you?',
  getStartedDescription: 'Start a conversation with our AI assistant to get instant answers.',
  ...
  pwaBannerPosition: 'under-header',
