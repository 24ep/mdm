...
export const GET = withErrorHandling(getHandler, 'GET /api/src\app\api\v1\dashboards\[id]\route.ts')
...
export const PUT = withErrorHandling(putHandler, 'PUT /api/src\app\api\v1\dashboards\[id]\route.ts')
