...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error('POST /integrations/manageengine-servicedesk/attachments error', error)
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('GET /integrations/manageengine-servicedesk/attachments error', error)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}
