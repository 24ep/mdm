...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('POST /integrations/manageengine-servicedesk/conflict-resolution error', error)
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('PUT /integrations/manageengine-servicedesk/conflict-resolution error', error)
    return NextResponse.json({ error: 'Internal server error' }, { status: 500 })
  }
}
